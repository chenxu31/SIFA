...
class SIFA:
    ...
    def __init__(self, args):
        ...
        self.data_iter = common_prostate_ck.DataIter(args.data_dir, patch_depth=args.patch_depth, batch_size=args.batch_size)
        ...
        _, self.val_data_t, _, self.val_label_t = common_prostate_ck.load_val_data(args.data_dir)
        self.test_data_s, self.test_data_t, self.test_label_s, self.test_label_t = common_prostate_ck.load_test_data(args.data_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default=r'/shenlab/lab_stor/xuchen/data/prostate_ck/h5_data', help='path of the dataset')
    ...
    parser.add_argument('--num_cls', type=int, default=3, help="") #TODOck
